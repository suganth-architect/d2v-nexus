        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    role = FOUNDER_EMAILS.includes(email) ? 'founder' : 'client';
                    // Create User Doc
 ...
 */
exports.createProject = functions.https.onCall(function (data, context) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    isFounder = FOUNDER_EMAILS.includes(callerEmail);
 ...
 */
exports.approvePettyCash = functions.https.onCall(function (data, context) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    callerEmail = context.auth.token.email;
                    if (!FOUNDER_EMAILS.includes(callerEmail)) {
                    ...
                    return [4 /*yield*/, db.runTransaction(function (t) {
                        return __awaiter(void 0, void 0, void 0, function () {
